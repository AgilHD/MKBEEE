...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-amber-100/50 p-1 text-amber-700/70 shadow-inner",
      className
    )}
    {...props}
  />
